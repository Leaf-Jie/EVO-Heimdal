...
public:
    ...
    //从文件设置相机参数
    static void modifyCameraAutoSetFromFile(Dahua::GenICam::ICameraPtr &cameraSptr);
     ...
     * @param offset 偏移量
    */
    static void autoModifyExposureTime(cv::Mat src, int grayAverage, Dahua::GenICam::ICameraPtr &cameraSptr, int offset = 1);
